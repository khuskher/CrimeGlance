...
mongoose
  .connect(
    "mongodb+srv://crimeGlance:crimeGlance@cluster0.evstr9t.mongodb.net/?retryWrites=true&w=majority",
    {
...
app.post("/api/reports", async (req, res) => {
  try {
    const { title, time, date, area, city, state, category, description } = req.body;
